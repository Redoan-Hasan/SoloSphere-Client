...
const Registration = () => {
  const { user, signInWithGoogle, createUser, updateUserProfile, setUser } =
    ...
    <div className="flex justify-center items-center min-h-[calc(100vh-306px)]">
      <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg lg:max-w-4xl ">
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
          <div className="flex justify-center mx-auto">
            <img
              ...
              src="https://github.com/shakilahmedatik/soloSphere-resources/blob/main/images/logo.png?raw=true"
              alt=""
            />
          </div>
        ...
        <div
          ...
          style={{
            backgroundImage: `url('https://github.com/shakilahmedatik/soloSphere-resources/blob/main/images/register.jpg?raw=true')`,
          }}
        ></div>
      </div>
    </div>
